...
# Human-like delays: 2-10 minutes between comments
COMMENT_MIN_DELAY = _int("COMMENT_MIN_DELAY", 120)
COMMENT_MAX_DELAY = _int("COMMENT_MAX_DELAY", 600)

# --- Connect limits ---
CONNECT_DAILY_LIMIT = _int("CONNECT_DAILY_LIMIT", 25)
CONNECT_WEEKLY_LIMIT = _int("CONNECT_WEEKLY_LIMIT", 100)
CONNECT_MIN_DELAY = _int("CONNECT_MIN_DELAY", 300)
CONNECT_MAX_DELAY = _int("CONNECT_MAX_DELAY", 900)
...
DAILY_CONNECT_LIMIT = CONNECT_DAILY_LIMIT
WEEKLY_LIKE_LIMIT = LIKE_WEEKLY_LIMIT
WEEKLY_COMMENT_LIMIT = COMMENT_WEEKLY_LIMIT
WEEKLY_CONNECT_LIMIT = CONNECT_WEEKLY_LIMIT
